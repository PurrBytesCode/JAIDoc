...
| Model                                         | Quantization | Context Size | Parallel-Slots |  Preferred agent  | Task             | URL                                                                               |
|-----------------------------------------------|:------------:|:------------:|:--------------:|:-----------------:|:-----------------|-----------------------------------------------------------------------------------|
...
| NVIDIA-Nemotron-3-Nano-Omni-30B-A3B-Reasoning |  IQ4_NL_XL   |  256K (MAX)  |       1        |       Junie       | General          | https://huggingface.co/unsloth/NVIDIA-Nemotron-3-Nano-Omni-30B-A3B-Reasoning-GGUF |
| NVIDIA-Nemotron-Cascade-2-30B-A3B             |    IQ4_NL    |   1M (MAX)   |       1        |       Junie       | Single task code | https://huggingface.co/bartowski/nvidia_Nemotron-Cascade-2-30B-A3B-GGUF           |
| Qwen3.6-27B                                   |    IQ4_NL    |     128K     |       1        |       Junie       | Very Hard Code   | https://huggingface.co/unsloth/Qwen3.6-27B-GGUF                                   |
| Qwen3.6-27B-MTP                               |    IQ4_NL    |     128K     |       1        |       Junie       | Very Hard Code   | https://huggingface.co/unsloth/Qwen3.6-27B-MTP-GGUF                               |
| Qwen3.6-35B-A3B                               | UD-IQ4_NL_XL |  256K (MAX)  |       1        |       Junie       | Hard Code        | https://huggingface.co/unsloth/Qwen3.6-35B-A3B-GGUF                               |
...
| Qwopus3.6-27B-v2                              |    IQ4_XS    |     128K     |       1        |    Claude Code    | Very Hard Code   | https://huggingface.co/Jackrong/Qwopus3.6-27B-v2-GGUF                             |
| Qwopus3.6-27B-v2-MTP                          |    IQ4_XS    |     128K     |       1        |    Claude Code    | Very Hard Code   | https://huggingface.co/Jackrong/Qwopus3.6-27B-v2-MTP-GGUF                         |
| Qwopus3.6-35B-A3B-v1                          |    IQ4_XS    |  256K (MAX)  |       1        |    Claude Code    | Hard Code        | https://huggingface.co/Jackrong/Qwopus3.6-35B-A3B-v1-GGUF                         |
| Qwopus3.6-35B-A3B-v1-agents                   |    IQ4_XS    |  256K (MAX)  |       1        |    Claude Code    | Hard Code        | https://huggingface.co/Jackrong/Qwopus3.6-35B-A3B-v1-GGUF                         |
