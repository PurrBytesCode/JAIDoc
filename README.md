...
| Qwen3.6-27B                                   |    IQ4_NL    |  256K (MAX)  |       1        |       Junie       |           | Very Hard Code   | https://huggingface.co/unsloth/Qwen3.6-27B-GGUF                                   |
| Qwen3.6-27B-MTP                               |    IQ4_NL    |  256K (MAX)  |       1        |       Junie       |           | Very Hard Code   | https://huggingface.co/unsloth/Qwen3.6-27B-MTP-GGUF                               |
...
| Qwopus3.6-27B-v2                              |    IQ4_XS    |  256K (MAX)  |       1        |    Claude Code    |           | Very Hard Code   | https://huggingface.co/Jackrong/Qwopus3.6-27B-v2-GGUF                             |
| Qwopus3.6-27B-v2-MTP                          |    IQ4_XS    |  256K (MAX)  |       1        |    Claude Code    |           | Very Hard Code   | https://huggingface.co/Jackrong/Qwopus3.6-27B-v2-MTP-GGUF                         |
| Qwopus3.6-35B-A3B-v1                          |    IQ4_XS    |  256K (MAX)  |       1        |    Claude Code    |    110    | Hard Code        | https://huggingface.co/Jackrong/Qwopus3.6-35B-A3B-v1-GGUF                         |
| Qwopus3.6-35B-A3B-v1-agents                   |    IQ4_XS    |  256K (MAX)  |       1        |    Claude Code    |    110    | Hard Code        | https://huggingface.co/Jackrong/Qwopus3.6-35B-A3B-v1-GGUF                         |
