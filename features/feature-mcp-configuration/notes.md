...
- Use `MethodToolCallbackProvider` instead of programmatically creating tool callbacks — this is cleaner and leverages Spring AI's built-in reflection mechanism.
